...
import 'package:Joswor/controller/OffersPageController.dart';
...
class OffersPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    OffersPageControllerImpl? controller1 = Get.put(OffersPageControllerImpl());
    HomePageControllerImpl controller = Get.put(HomePageControllerImpl());
    MyService myservice = Get.find();
    CarouselOffersControllerImpl? controller2 =
        Get.put(CarouselOffersControllerImpl());
    var formKey = controller1!.formKey;
